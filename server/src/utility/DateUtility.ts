export function convertToUnix(date: Date): number | Error {
...
export function getDateString(currency: string): string {
...
// Accepts unix
export function daysRemainingUntil(date: number): number {
